...
description: "Audit an Autoplan integration against the house standard and produce a prioritised gap report — committed secrets, disabled tests, missing config validation, no resilience, missing IaC or pipeline, monolithic clients, telemetry drift. WHEN: \"review this integration\", \"audit this repo\", \"does this follow our standard\", \"conformance check\", \"what's missing in this project\", \"health check this integration\", \"is this repo up to standard\", \"find gaps\", \"tech debt in this integration\", \"onboarding review\", \"pre-handover review\", \"check for committed secrets\"."
license: MIT
metadata:
