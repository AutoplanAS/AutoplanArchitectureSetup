<#
.SYNOPSIS
    Removes the Autoplan webapp skills from one or more AI agents' skills directories.

.DESCRIPTION
    Removes only skill folders from this package (`autoplan-webapp-*`) and by default only
